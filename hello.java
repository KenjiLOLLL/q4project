...
class main_page extends javax.swing.JFrame {
    ...
    private void initComponents() {                                           // method
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {             // method                             
        // TODO add your handling code here:
    }                                        

    private void jRadioButton1ActionPerformed(java.awt.event.ActionEvent evt) {        // method                                       
    ...
    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {        // method                                      
    ...
    private void jRadioButton3ActionPerformed(java.awt.event.ActionEvent evt) {          // method                                    
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {             // method                            
        if(jRadioButton1.isSelected()){
            p1++;
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {           // method                              
        if(p1>p2 && p1>p3){
